define(require => {
    ...
    function init() {
        ...
        let logoText = new PIXI.Sprite(new PIXI.Texture.fromFrame('wheel-bonus-text'));
    ...
    function stopWinHighlight() {
        Tween.to(segmentHighlight, 0.8, {
            alpha: 0, delay: 0.5, ease: window.Power2.easeOut, onComplete: function () {
                segmentHighlight.renderable = false;
        ...
        if (data === 'WheelBonus') {
            ...
            tl.fromTo(displayList.wheelBonusLogo, fadeTime, {
                ...
                },
                {
                    ...
                    ease: window.Power2.easeOut,
                    onComplete: function () {
                        logoGlow.state.setAnimation(0, 'PrizeBonus/PrizeBonusIconGlow_' + colourScheme.colour, true);
